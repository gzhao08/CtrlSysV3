...
module ctrlsys_core #(
    ...
    parameter integer SENS0_REG_ADDR = 0,
    parameter integer SENS0_NUM_BYTES = 0,
    parameter integer SENS1_PROTOCOL = 0,
    parameter integer SENS1_ADDR = 0,
    parameter integer SENS1_REG_ADDR = 0,
    parameter integer SENS1_NUM_BYTES = 0,
    parameter integer SENS2_PROTOCOL = 0,
    parameter integer SENS2_ADDR = 0,
    parameter integer SENS2_REG_ADDR = 0,
    parameter integer SENS2_NUM_BYTES = 0,
